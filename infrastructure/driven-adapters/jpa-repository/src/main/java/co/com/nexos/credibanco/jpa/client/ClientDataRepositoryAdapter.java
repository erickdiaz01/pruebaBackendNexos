...
@Repository
public class ClientDataRepositoryAdapter extends
        AdapterOperations<Client/* change for domain model */, ClientData/* change for adapter model */, String, ClientDataRepository>
